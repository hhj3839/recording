...
export async function POST(request: Request) {
  try {
    ...
    const modeInstruction = mode === "regenerate"
      ? `이 학생의 기존 평어를 참고하거나 수정하지 말고, 아래 평가 근거만 사용하여 평어 전체를 처음부터 새로 작성해 줘. 평가 영역마다 정확히 1문장씩 총 ${activeEvidenceCount}문장을 작성하고, 각 문장은 60~80자이며 자연스러운 명사형으로 끝내. 근거에 없는 행동·태도·과정을 추가하지 마.`
      : mode === "shorter"
