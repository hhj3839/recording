...
- 정확성·완성도·속도·숙련도·수행 방식도 관찰 사실이다. 선택 수준 기준이나 사용 가능한 활동 근거에 직접 없으면 행동에 새 수식어를 붙이지 않는다.
- 평가기준에 없는 도구·재료 사용, 수행 순서·단계, 관찰·확인, 문제·상황에 맞춘 판단, 선택·필요성 판단, 정리·기록 과정을 그럴듯한 장면으로 보충하지 않는다.
